...
void main() {
  ...
  testWidgets('sin sesión, la app se construye y muestra la pantalla de inicio '
      'de sesión', (WidgetTester tester) async {
    ...
    expect(find.text('Palito de Sabores'), findsOneWidget);
