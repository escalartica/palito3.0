...
const List<Category> gastronomicCategories = [
  ...
  Category(
    name: "Ensaladilla",
    iconPath: "assets/icons/iconoTenedorCaraFeliz.png",
  ),
  ...
  Category(
    name: "Plato Estrella",
    iconPath: "assets/icons/iconoTenedorConEstrella.png",
  ),
  Category(
    name: "Postres / Helados",
    iconPath: "assets/icons/iconoEstrellaRosa.png",
  ),
  Category(
    name: "Decoración / Espacio",
    iconPath: "assets/icons/iconoCasa.png",
  ), // Añadido
