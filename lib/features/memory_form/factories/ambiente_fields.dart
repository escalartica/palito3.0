    ...
    return [
      ...
      _buildCompactChipGroup(
        ...
        [
          ...
          {
            'label': 'Calle con encanto',
            'icon': Icons.location_city_outlined,
          },
          {
            'label': 'Cerca del asfalto',
