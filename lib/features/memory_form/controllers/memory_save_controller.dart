  ...
  Future<MemorySaveResult> save({
    ...
    if (tempMediaBytes != null) {
      ...
      try {
        ...
        debugPrint('⚠️ No se pudo subir la foto del recuerdo: $e');
    ...
    if (existingMemory != null) {
      await ref.read(memoryProvider.notifier).updateMemory(newMemory);
    } else {
      await ref.read(memoryProvider.notifier).addMemory(newMemory);
    }
